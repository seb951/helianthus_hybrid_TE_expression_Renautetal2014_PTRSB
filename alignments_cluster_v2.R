...
{bwa_aln1 = paste("bwa aln -t 8 -q 20 reference/HA412_trinity_noAltSplice_400bpmin.fa data/",sub(".fq","_trim1.fq",individuals[i,5]),"  >alignments/",sub(".fq","_trim1.fq",individuals[i,5]), ".sai", sep = "");
bwa_aln2 = paste("bwa aln -t 8 -q 20 reference/HA412_trinity_noAltSplice_400bpmin.fa data/",sub(".fq","_trim2.fq",individuals[i,5]),"  >alignments/",sub(".fq","_trim2.fq",individuals[i,5]), ".sai", sep = "")}

	if((individuals[i,3] == "ill") & (individuals[i,4] == "Ill1.3")) # old illumina quality format specified in the "list_ind" file
{bwa_aln1 = paste("bwa aln -I -t 8 -q 20 reference/HA412_trinity_noAltSplice_400bpmin.fa data/",sub(".fq","_trim1.fq",individuals[i,5]),"  >alignments/",sub(".fq","_trim1.fq",individuals[i,5]), ".sai", sep = "");
bwa_aln2 = paste("bwa aln -I -t 8 -q 20 reference/HA412_trinity_noAltSplice_400bpmin.fa data/",sub(".fq","_trim2.fq",individuals[i,5]),"  >alignments/",sub(".fq","_trim2.fq",individuals[i,5]), ".sai", sep = "")}

	if(individuals[i,3] == "ill")
bwa_sampe = paste("bwa sampe reference/HA412_trinity_noAltSplice_400bpmin.fa alignments/",sub(".fq","_trim1.fq",individuals[i,5], fixed = T), ".sai"," alignments/",sub(".fq","_trim2.fq",individuals[i,5], fixed = T), ".sai data/",gsub(".fq","_trim1.fq",individuals[i,5])," data/",gsub(".fq","_trim2.fq",individuals[i,5])," >alignments/",individuals[i,5], ".sam", sep = "")
...
sam_rm = paste("rm alignments/",individuals[i,5], ".bam ", "alignments/",individuals[i,5], ".sam alignments/",sub(".fq","_trim1.fq.sai",individuals[i,5])," alignments/",sub(".fq","_trim2.fq.sai",individuals[i,5]),sep = "")
